...
const AddBillButton = ({ tooltipLabel, tooltipPlacement, createBill, ...rest }) => {
  ...
  return (
    <>
      ...
      {
        openBillModalForm && <BillModalForm open={openBillModalForm} close={closeBillModalForm} onSubmit={createBill} />
      }
    </>
  )
}
